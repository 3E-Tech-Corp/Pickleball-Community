...
export const useSharedAuth = () => {
  ...
  const redirectToLogin = useCallback((returnTo) => {
    ...
    window.location.href = `${SHARED_AUTH_UI_URL}/login?redirect=${encodeURIComponent(redirectUrl)}&returnTo=${encodeURIComponent(returnPath)}&site=pickleball.Community`
  }, [location])
  ...
  const redirectToRegister = useCallback(() => {
    ...
    window.location.href = `${SHARED_AUTH_UI_URL}/register?redirect=${encodeURIComponent(redirectUrl)}&site=pickleball.Community`
  }, [])
  ...
  const redirectToForgotPassword = useCallback(() => {
    ...
    window.location.href = `${SHARED_AUTH_UI_URL}/forgot-password?redirect=${encodeURIComponent(redirectUrl)}&site=pickleball.Community`
  }, [])
  ...
  const getLoginUrl = useCallback((returnTo) => {
    ...
    return `${SHARED_AUTH_UI_URL}/login?redirect=${encodeURIComponent(redirectUrl)}&returnTo=${encodeURIComponent(returnPath)}&site=pickleball.Community`
  }, [])
  ...
  const getRegisterUrl = useCallback(() => {
    ...
    return `${SHARED_AUTH_UI_URL}/register?redirect=${encodeURIComponent(redirectUrl)}&site=pickleball.Community`
  }, [])
